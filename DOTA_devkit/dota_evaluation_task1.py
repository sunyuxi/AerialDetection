...
def main():
    ...
    detpath = r'/mnt/A/sunyuxi/objectdetection/AerialDetection/work_dirs/faster_rcnn_RoITrans_r50_fpn_1x_dota_val/Task1_results/{:s}.txt'
    annopath = r'/mnt/A/sunyuxi/objectdetection/AerialDetection/data/DOTA1_1024/val1024/labelTxt/{:s}.txt' # change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
    imagesetfile = r'/mnt/A/sunyuxi/objectdetection/AerialDetection/data/DOTA1_1024/val1024/valset.txt'
